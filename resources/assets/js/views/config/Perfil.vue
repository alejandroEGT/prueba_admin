				...
				<el-col :span="4" >
					<form method="POST" id="form1" enctype="multipart/form-data">
						<div class="file-upload" v-loading="img_load">
						 	...
						 	<img accept="image/*" :src=" foto " height="120" width="135"  >
...
<script type="text/javascript">
	import { getProyecto, submitConfig } from '../../endpoints';
	export default{
		data(){
			return {
				img_load:true,
			...
			get_Proyecto(){
				getProyecto(this.$route.params.id).then((response)=>{
              		...
              		if (response.data.foto == null) {
              			this.foto = 'https://help.github.com/assets/images/help/profile/identicon.png';
              		}else{
		      ...
		      onSubmitFoto(){
		      	...
		      	axios.post('frontend/updateFotoProject', new FormData(form)).then((res)=>{
		      		this.$message({
                      message: res.data,
                      type: 'success'
                    });
